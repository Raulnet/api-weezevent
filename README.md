...
- web component service for Weezevent-api (v1.2.2*)
...
Declare component and his attribute:
        ...
        <service-weezevent
            ...
            api-fire-response="yourCustomEvent"
...
---                 | ---       | ---                       | ---
`api-key`           | *String*  | ``                        | Api key (provided by weezevent)
`access-token`      | *String*  | ``                        | Generated by service function getAuthAccessToken()
`api-fire-response` | *String*  | `api-weezevent-response`  | provide element event handle response
`params`            | *Object*  | ``                        | Json Object parameters for request api.

## Events

name                        | Description
---                         | --- 
`api-weezevent-response`    | Triggered when api return response
